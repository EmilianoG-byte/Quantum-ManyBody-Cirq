...
\usepackage{amsmath}
\DeclareMathOperator{\Tr}{Tr} % to define the trace
...
\newcommand{\hadamard}{\ensuremath{\frac{1}{\sqrt{2}}\begin{pmatrix} 1&1\\1&1\end{pmatrix}}}
...
\newcommand{\yx}[1]{\ensuremath\mathrm{#1}}
